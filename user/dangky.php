	...
	<div class="container">
		<div class="row">
			...
			<div class="breadcrumb-w col-sm-5">
				<span>Bạn ở đây:</span>
				<ul class="breadcrumb"><li><a href="index.php">Trang chủ</a></li><li><span>Đăng ký</span></li></ul>			</div>
		</div>
	</div>
</section>
    ...
    <img src="https://imap.princeton.edu/sites/g/files/toruqf1601/files/imap-mark-hor-multicolor-dark.png"/>
        <form action="xuly.php" method="POST">
            ...
            <label for="inputEmail">Họ tên</label>
                <input  class="form-control" id="inputEmail" type="text" required name="hoten" />
            </div>
            <div class="form-floating mb-6" style="margin-top : 15px">
            <label for="inputPassword">Email</label>
                <input class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" id="inputPassword" type="email" required name="email" />
            </div>
            <div class="form-floating mb-6" style="margin-top : 15px">
