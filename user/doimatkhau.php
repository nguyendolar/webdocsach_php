	...
	<div class="container">
		<div class="row">
			...
			<div class="breadcrumb-w col-sm-5">
				<span>Bạn ở đây:</span>
				<ul class="breadcrumb"><li><a href="index.php">Trang chủ</a></li><li><span>Đổi mật khẩu</span></li></ul>			</div>
		</div>
	</div>
</section>
    ...
    <img src="https://imap.princeton.edu/sites/g/files/toruqf1601/files/imap-mark-hor-multicolor-dark.png"/>
        <form action="xuly.php" method="POST">
            ...
            <label for="inputEmail">Mật khẩu cũ</label>
                <input class="form-control" pattern="[A-Za-z0-9]+" id="inputEmail" type="password" required name="matkhaucu" />
            </div>
            <div class="form-floating mb-6" style="margin-top : 15px">
            <label for="inputPassword">Mật khẩu mới</label>
                <input class="form-control" pattern="[A-Za-z0-9]+" id="inputPassword" type="password" required name="matkhaumoi" />
            </div>
            <div class="d-flex align-items-center justify-content-between mt-4 mb-0" style="margin: 15px 150px !important">
                <button class="btn btn-primary" type="submit" style="background-color : #FFCC2A; color : black" name="doimk" >Đổi mật khẩu</button>
            </div>
        </form>
    </div>
</div>
