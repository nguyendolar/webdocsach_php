...
$tenoday = $row['demuc']."/ ".$row['tenloaibaidang'];
}
if(isset($_GET["demuc"])){
    $id = $_GET["demuc"];
    if($id == 1) {
	...
	<div class="container">
		<div class="row">
			...
			<div class="breadcrumb-w col-sm-5">
				<span>Bạn ở đây:</span>
				<ul class="breadcrumb"><li><a href="index.php">Trang chủ</a></li><li><span><?php echo $tenoday ?></span></li></ul>			</div>
		</div>
	</div>
</section>
	...
	<ul>
		...
		?>
			...
			<li class="pro-item col-md-4 col-sm-6 col-xs-12">
				<a href="chitiet.php?id=<?php echo $rows['id'] ?>">
					<div class="product-image-action">
						<img style="width : 300px; height : 190px" src="../admin/image/<?php echo $rows['anh'] ?>" alt="<?php echo $rows['tieude'] ?>"/>						<div class="action">
							<p style="
								position: absolute;
								right: -190px;
								bottom: -120px;
				...
				<div class="product-info">
					<a href="chitiet.php?id=<?php echo $rows['id'] ?>" class="product-name"><?php echo $rows['tieude'] ?></a>				</div>
			</li>
			<!-- Bài đăng -->	
			<?php } ?>
			</ul>
