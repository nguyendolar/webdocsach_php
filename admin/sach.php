                        ...
                        <div class="card-body">
                            <table id="datatablesSimple" class="table table-bordered">
                                ...
                                <tr style="background-color : #6D6D6D">
                                        <th>STT</th>
                                        <th>Tên sách</th>
                                        <th style="width: 190px !important">Ảnh</th>
                                        <th>Tác giả</th>
                                        <th>Nội dung</th>
                                        <th>Thao tác</th>
                                    </tr>
                                ...
                                <?php 
                                    ...
                                    <tr style="border-bottom: 1px solid red !important;">
                                        <td><?php echo $stt ?></td>
                                        <td><?php echo $arUser["tensach"] ?></td>
                                        <td><img style="width: 180px !important;height: 230px !important;" src="./image/<?php echo $arUser['anh'] ?>"></td>
                                        ...
                                        <td style="width : 130px !important">
                                         ...
                                         aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel"><?php echo $arUser["tensach"] ?></h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                    aria-label="Close"></button>
                                                        </div>
                                                    ...
                                                    <form action="function.php" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="col-4">
                                                            <label for="category-film"
                                                                ...
                                                                <input type="text" class="form-control" id="category-film" value="<?php echo $arUser["tensach"] ?>" name="tensach" required>
                                                        </div>
                                                        <div class="col-4">
                                                            <label for="category-film"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div class="col-4">
                                                            <label for="category-film"
                                                                class="col-form-label">Tên sách:</label>
                                                                <input type="text" class="form-control" id="category-film" name="tensach" required>
                                                        </div>
                                                        <div class="col-4">
                                                            <label for="category-film"
                                                                class="col-form-label">Tác giả:</label>
