        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Danh sách lịch sử giao dịch</h1>
                    <div class="card mb-4">
                            ...
                            <table id="datatablesSimple">
                                ...
                                <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $arUser["ngaygui"] ?></td>
                                        <td>
                                            <?php if($arUser["capbac"] == 3) {?>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form action="function.php" method="post">
                                                                ...
                                                                <div class="mt-2">
                                                                    ...
                                                                    <option value="2">Không nhận được tiền</option>
                                                                    </select>
                                                                ...
                                                                <div class="modal-footer" style="margin-top: 20px">
                                                                    ...
                                                                    <button style="width:100px" type="submit" class="btn btn-primary" name="xlct"> Lưu</button>
